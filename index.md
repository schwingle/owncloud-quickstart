...
Run the Installation Wizard to complete the installation.
  ...
  3. Click __Storage and Database__ to set your data directory location and database connection.
      ...
      - __Important!__ Your ownCloud data directory must already exist, be owned by your HTTP user, and be exclusive to ownCloud (not be modified manually by any other process or user).
